 ...
 * <code>public void</code> method to which it is attached can be run as a test
 ...
 * </code>
 * <p>
 * The <code>Test</code> annotation supports two optional parameters. The first,
 * <code>expected</code>, declares that a test method should throw an exception.
 * If it doesn't throw an exception or if it throws a different exception than
 * the one declared, the test fails. For example, the following test succeeds:
 * <br>
 * <code>
 ...
 * </code>
 * <p>
 * The second optional parameter, <code>timeout</code>, causes a test to fail if
 * it takes longer than a specified amount of clock time (measured in
