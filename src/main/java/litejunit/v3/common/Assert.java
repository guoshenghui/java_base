...
import litejunit.v3.common.ComparisonFailure;
...
public class Assert {
	 ...
	 * considered equal: assertEquals(Double.NaN, Double.NaN, *) passes
	 */
	...
	/**
	 * Asserts that two doubles are equal to within a positive delta. If they
	 * are not, an AssertionError is thrown. If the expected value is infinity
	 * then the delta value is ignored.NaNs are considered equal:
	 ...
	 * not, an AssertionError is thrown with the given message. If the expected
	...
	/**
	 * Asserts that two floats are equal to within a positive delta. If they are
	 * not, an AssertionError is thrown. If the expected value is infinity then
	 * the delta value is ignored.NaNs are considered equal:
	...
	/**
	 * Asserts that an object is null. If it is not, an AssertionError is thrown
	 * with the given message.
	 */
