 ...
 * <code>Description</code> will be of a single test. However, if problems are
 * encountered while constructing the test (for example, if a
 * <code>@BeforeClass</code> method is not static), it may describe something
 * other than a single test.
 */
public class Failure {
	 ...
	 * @param thrownException the exception that was thrown while running the
	 *        test
	 */
