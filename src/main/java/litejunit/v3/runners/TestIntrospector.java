...
import litejunit.v3.BeforeClass;
import litejunit.v3.Ignore;
import litejunit.v3.Test;
import litejunit.v3.Test.None;
...
public class TestIntrospector {
	 ...
	 * ArrayList<Class> results= new ArrayList<Class>(); Class<?> current=
	 * testClass; while (current != null) { results.add(current); current=
	 * current.getSuperclass(); } return results; }
	 */
