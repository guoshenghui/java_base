package litejunit.v3.notification;
...
import litejunit.v3.runner.Result;
 ...
 * your implementation of <code>Runner.run(RunNotifier notifier)</code>. Future
 * evolution of this class is likely to move <code>fireTestRunStarted()</code>
 * and <code>fireTestRunFinished()</code> to a separate class since they should
...
public class RunNotifier {
	 ...
	 * @param description the description of the atomic test (generally a class
	 *        and method name)
	 * @throws StoppedByUserException thrown if a user has requested that the
	 *         test run stop
	 */
	 ...
	 * @param failure the description of the test that failed and the exception
	 *        thrown
	 */
	 ...
	 * <code>fireTestFinished()</code> if you invoke
	 * <code>fireTestStarted()</code> as listeners are likely to expect them to
	 * come in pairs.
