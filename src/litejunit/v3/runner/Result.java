 ...
 * multiple tests. Since tests are expected to run correctly, successful tests
 * are only noted in the count of tests that ran.
 */
public class Result {
	...
	/**
	 * @return the <code>Failures</code> describing tests that failed and the
